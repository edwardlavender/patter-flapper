...
#### Validate revised acs_setup_detection_kernels() routine (~0 s)
if (FALSE) {
  
  # This code validated the new acs_setup_detection_kernels() routine (revised on 2024-01-03).
  # Both kernels and old_kernels at that time were created using gamma = 750 m.
  # Subsequently we increased gamma.
  # This validation is no longer implemented.
